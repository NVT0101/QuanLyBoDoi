    ...
    public class WordProcess
    {
        ...
        public void Mau1(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[1].AddParagraph().AppendText($"{lp[i].Name}\n{lp[i].txtDonVi()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[2].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[3].AddParagraph().AppendText(lp[i].GetMember(QUANHE.ME).Name)
                    .CharacterFormat.FontName = "Times New Roman";
        ...
        public void Mau2(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[1].AddParagraph().AppendText($"{lp[i].Name}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[2].AddParagraph().AppendText(lp[i].txtDonVi())
                    .CharacterFormat.FontName = "Times New Roman";
               newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText(lp[i].LydoLyHon)
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau3(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[0].AddParagraph().AppendText($"{i + 1}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[1].AddParagraph().AppendText(lp[i].txtDonVi())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[2].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                /*newRow.Cells[3].AddParagraph().AppendText($"{lp[i].GetMember("cha")}, {lp[i].GetMember()}")
                    .CharacterFormat.FontName = "Times New Roman";*/
                newRow.Cells[4].AddParagraph().AppendText(lp[i].PrintAllGDNNName(3))
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText(lp[i].PrintAllGDNNQuanHe(3))
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[6].AddParagraph().AppendText(lp[i].PrintAllGDNNQuocGia(3))
                    .CharacterFormat.FontName = "Times New Roman";
                string[] timeTxt = lp[i].PrintAllGDNNThoiGian(3);
                newRow.Cells[7].AddParagraph().AppendText(timeTxt[0])
                        .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[8].AddParagraph().AppendText(timeTxt[1])
                        .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[9].AddParagraph().AppendText(timeTxt[2])
                        .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[10].AddParagraph().AppendText(timeTxt[3])
                        .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[11].AddParagraph().AppendText(lp[i].PrintAllGDNNGhiChu(3))
                        .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau7(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[2].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[3].AddParagraph().AppendText($"{lp[i].PrintParent()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText(lp[i].PrintAllVPPLThoiGian(8))
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText($"{lp[i].PrintAllVPPLNoiDung(8)}")
                    .CharacterFormat.FontName = "Times New Roman";
                string[] mucdoVP = lp[i].PrintAllVPPLMucDo(8);
                newRow.Cells[6].AddParagraph().AppendText(mucdoVP[0])
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[7].AddParagraph().AppendText(mucdoVP[1])
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[8].AddParagraph().AppendText(mucdoVP[2])
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[9].AddParagraph().AppendText(mucdoVP[3])
                    .CharacterFormat.FontName = "Times New Roman";
        ...
        public void Mau8(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[4].AddParagraph().AppendText(lp[i].PrintAllVPPLThoiGian(8))
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText($"{lp[i].PrintAllVPPLLyDo(8)}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[6].AddParagraph().AppendText($"{lp[i].PrintAllVPPLHauQua(8)}")
                    .CharacterFormat.FontName = "Times New Roman";
                string[] mucdoVP = lp[i].PrintAllVPPLMucDo(8);
                newRow.Cells[7].AddParagraph().AppendText(mucdoVP[0])
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[8].AddParagraph().AppendText(mucdoVP[1])
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[9].AddParagraph().AppendText(mucdoVP[2])
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[10].AddParagraph().AppendText(mucdoVP[3])
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[11].AddParagraph().AppendText(lp[i].PrintAllVPPLGhiChu(8))
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau9(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{Common.GetEnumDescription(lp[i].Dantoc)}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText($"{Common.GetEnumDescription(lp[i].TrinhDo)}")
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau10(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{lp[i].MoTaHoanCanh}")
                    .CharacterFormat.FontName = "Times New Roman";
        ...
        public void Mau11(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[5].AddParagraph().AppendText(lp[i].PrintAllGDNNQuocGia(11))
                    .CharacterFormat.FontName = "Times New Roman";
                string[] timeTxt = lp[i].PrintAllGDNNThoiGian(11);
                newRow.Cells[6].AddParagraph().AppendText(timeTxt[0])
                        .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[7].AddParagraph().AppendText(timeTxt[1])
                        .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[8].AddParagraph().AppendText(timeTxt[2])
                        .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[9].AddParagraph().AppendText(timeTxt[3])
                        .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[10].AddParagraph().AppendText(lp[i].PrintAllGDNNGhiChu(11))
                        .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau12(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText($"{lp[i].PrintParent()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText(lp[i].PrintLydoBomeMat())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText($"{lp[i].GD.Find(g => g.NguoiNuoiDuong).Name}")
                    .CharacterFormat.FontName = "Times New Roman";
                /*newRow.Cells[10].AddParagraph().AppendText(lp[i].PrintAllVPPLGhiChu(8))
                    .CharacterFormat.FontName = "Times New Roman";*/
            }
        ...
        public void Mau14(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{lp[i].PrintParent()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText($"{lp[i].PrintAllNDXam()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[6].AddParagraph().AppendText($"{lp[i].PrintAllViTriDienTichXam()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[7].AddParagraph().AppendText($"{lp[i].PrintAllYNghiaXam()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[8].AddParagraph().AppendText($"{lp[i].PrintAllLydothoigianXam()}")
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau17(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{Common.GetEnumDescription(lp[i].Tongiao)}")
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau21(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{lp[i].TTThuongBB}")
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau22(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{lp[i].TTCTTrongQD}")
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau23(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{lp[i].TTLietsi}")
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau24(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{lp[i].TTMeVNAH}")
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau25(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText(lp[i].NghienThuoc ? lp[i].MucDoNT : lp[i].MucDoNR)
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau26(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[2].AddParagraph().AppendText(lp[i].txtDonVi())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText(lp[i].TTMXH)
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText(lp[i].GhiChuMXH)
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau27(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText(lp[i].TTNhuomToc)
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText(lp[i].LydoNhuomToc)
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau28(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText(lp[i].TruongHoc)
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText(lp[i].ChuyenNganh)
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau29(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText(lp[i].txtChoO())
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText(lp[i].HotenCBDV)
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText(lp[i].QuanheCBDV)
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau30(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[2].AddParagraph().AppendText($"{lp[i].PrintParent()}\n{lp[i].txtChoO()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[3].AddParagraph().AppendText($"{Common.GetEnumDescription(lp[i].Dantoc)}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{Common.GetEnumDescription(lp[i].Tongiao)}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText($"{Common.GetEnumDescription(lp[i].Vanhoa)}")
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau31(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText($"{lp[i].txtChoO()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{lp[i].HotenNY}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText($"{lp[i].TuoiNY}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText($"{lp[i].SDTNY}")
                    .CharacterFormat.FontName = "Times New Roman";
            }
            //Save the result document
        ...
        public void Mau32(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText($"{lp[i].txtChoO()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{lp[i].GetMember(QUANHE.VO).Name}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText($"{lp[i].GetMember(QUANHE.VO).NgheNghiep}")
                    .CharacterFormat.FontName = "Times New Roman";
        ...
        public void Mau35(List<People> lp)
        {
            ...
            for (int i = 0; i < lp.Count(); i++)
            {
                ...
                newRow.Cells[3].AddParagraph().AppendText($"{lp[i].txtChoO()}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[4].AddParagraph().AppendText($"{lp[i].MotaBenhNguoiThan}")
                    .CharacterFormat.FontName = "Times New Roman";
                newRow.Cells[5].AddParagraph().AppendText($"{lp[i].ThoiGianBenhNguoiThan}")
                    .CharacterFormat.FontName = "Times New Roman";
                /*newRow.Cells[5].AddParagraph().AppendText($"{lp[i].PrintCon()}")
                    .CharacterFormat.FontName = "Times New Roman";*/
            }
        ...
        public void Mau36(List<People> lp)
        {
            ...
            doc.Replace("<<Con1>>", $"{lp.Count(p => p.GD.Count(g => g.QuanHe == QUANHE.ANH 
            || g.QuanHe == QUANHE.CHI || g.QuanHe == QUANHE.EMT || g.QuanHe == QUANHE.EMG) == 0)}", true, true);
